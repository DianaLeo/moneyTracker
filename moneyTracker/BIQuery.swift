...
class BIQuery {
    ...
    func resultOfQuery() -> String? {
        ...
        if sqlite3_prepare_v2(db, readSQL.UTF8String, -1, &pStmt, nil) == SQLITE_OK {
            ...
            while sqlite3_step(pStmt) == SQLITE_ROW {
                //let num = sqlite3_column_int(pStmt, 0)
                result = String.fromCString(UnsafePointer(sqlite3_column_text(pStmt, 0)))
                //result = sqlite3_column_double(pStmt, 0)
                //println("BIDataSet Instance ID = \(num)")
            }
        }else{
    ...
    func resultsOfQuery() -> [Double] {
        ...
        if sqlite3_prepare_v2(db, readSQL.UTF8String, -1, &pStmt, nil) == SQLITE_OK {
            ...
            while sqlite3_step(pStmt) == SQLITE_ROW {
                //let num = sqlite3_column_int(pStmt, 0)
                //results += String.fromCString(UnsafePointer(sqlite3_column_text(pStmt, 7)))!
                let result = sqlite3_column_double(pStmt, 0)
    ...
    func resultsOfQuery() -> [Int] {
        ...
        if sqlite3_prepare_v2(db, readSQL.UTF8String, -1, &pStmt, nil) == SQLITE_OK {
            ...
            while sqlite3_step(pStmt) == SQLITE_ROW {
                //let num = sqlite3_column_int(pStmt, 0)
                //results += String.fromCString(UnsafePointer(sqlite3_column_text(pStmt, 7)))!
                let result = Int(sqlite3_column_int(pStmt, 0))
                results.append(result)
                //println("BIDataSet Instance ID = \(num)")
            }
        }else{
    ...
    func resultsOfQuery() -> [String] {
        ...
        if sqlite3_prepare_v2(db, readSQL.UTF8String, -1, &pStmt, nil) == SQLITE_OK {
            ...
            while sqlite3_step(pStmt) == SQLITE_ROW {
                //let num = sqlite3_column_int(pStmt, 0)
                //results += String.fromCString(UnsafePointer(sqlite3_column_text(pStmt, 7)))!
                let result = String.fromCString(UnsafePointer(sqlite3_column_text(pStmt, 0)))!
                //Int(sqlite3_column_int(pStmt, 0))
                results.append(result)
                //println("BIDataSet Instance ID = \(num)")
            }
        }else{
